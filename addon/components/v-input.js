...
// import layout from '../templates/components/v-input';
...
import ComponentInputId from '../mixins/v-component-input-id';
import InputBased from '../mixins/v-input-based';
import TooltipEnabled from '../mixins/v-tooltip-enabled';
import Namespace from '../mixins/v-namespace';
import layout from '../templates/components/v-input';

/**
 * @module
 * @augments ember/Component
 * @augments module:mixins/v-component-input-id
 * @augments module:mixins/v-input-based
 * @augments module:mixins/v-namespace
 * @augments module:mixins/v-tooltip-based
 */
export default Ember.Component.extend( ClassPrefix, ComponentInputId, InputBased, Namespace, TooltipEnabled, {
